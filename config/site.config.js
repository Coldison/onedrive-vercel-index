...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'samdie2016@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/coldison/onedrive-vercel-index',
    },
  ],
